package com.example.dimi.imagerecognitionproject;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView result1, labels1, labels2, texts1, texts2, landmarks1, landmarks2;
    Account mAccount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        labels1 = (TextView) findViewById(R.id.labels1);
        labels2 = (TextView) findViewById(R.id.labels2);
        texts1 = (TextView) findViewById(R.id.texts1);
        texts2 = (TextView) findViewById(R.id.texts2);
        landmarks1 = (TextView) findViewById(R.id.landmarks1);
        landmarks2 = (TextView) findViewById(R.id.landmarks2);
        ...
        new AsyncTask<Object, Void, BatchAnnotateImagesResponse>() {
            ...
            protected BatchAnnotateImagesResponse doInBackground(Object... params) {
               ...
               //     return convertResponseToString(response);
                ...
                return null;//"Cloud Vision API request failed.";
            }
            ...
            protected void onPostExecute(BatchAnnotateImagesResponse response) {
                ...
                if(response==null) {
                    labels1.setText("Analysis failed. Check your internet connection.");
                } else {

                    labels1.setText("Labels:");
                    texts1.setText("Texts:");
                    landmarks1.setText("Landmarks:");
                    ...
                    if (labels != null) {
                        ...
                        message.append("No label found!\n");
                    }
                    labels2.setText(message.toString());
                    ...
                    if (texts != null) {
                        ...
                        message.append("No text found!\n");
                    }
                    texts2.setText(message.toString());
                    ...
                    if (landmarks != null) {
                        ...
                        message.append("No landmark found!\n");
                    }
                    landmarks2.setText(message.toString());
                }
